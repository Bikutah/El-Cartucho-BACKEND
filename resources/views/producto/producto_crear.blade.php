...
<input type="hidden" id="initial-categories" value="{{ json_encode(array_map('intval', old('categorias', []))) }}">
<input type="hidden" id="selected-subcategorias" value="{{ json_encode(array_map('intval', old('subcategorias', []))) }}">
