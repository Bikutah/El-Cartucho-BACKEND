@if ($items->count())
    ...
    @if (isset($columnas) && is_array($columnas))
        <div class="row g-2 border-bottom pb-2 mb-3 px-2 py-1 rounded" 
             style="background-color: var(--color-indigo-dark) !important; color: #fff; font-weight: bold;">
            @foreach ($columnas as $columna)
                <div class="col {{ $columna['class'] ?? '' }}">
